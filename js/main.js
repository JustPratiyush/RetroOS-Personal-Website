 ...
 * Handles core OS functionalities like window management, clock, boot sequence,
...
function updateClock(forceUpdate = false) {
  ...
  if (clockApp && (forceUpdate || !clockApp.style.display || !clockApp.style.display.includes('none'))) {
    const options = { 
      weekday: 'long',
      year: 'numeric',
      month: 'long',
    ...
    const clockContent = `
      <div style="text-align: center; padding: 20px; font-family: 'VT323', monospace;">
        ...
        <div style="font-size: 18px; margin-bottom: 15px;">
          ...
          ${now.toLocaleDateString(undefined, { month: 'long' })} ${now.getDate()}, ${now.getFullYear()}
        </div>
